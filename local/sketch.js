...
//  var numericallyVague = [	"most", "mostly", "of course", "largely", "some", "probably", "the most common", "or more", "or less", "linked to", "has links to", "scholars", "almost", "certainly", "experts", "many", "often", "it is said", "it is known", "people say", "it has been", "critics", "it stands to reason", "questions have been raised", "experience shows", "may have", "officially", "it turns out", "award-winning", "a recent study", "come to be", "came to be", "up to", "vast majority", "good", "better", "upright", "honorable", "moral", "righteous", "great", "true", "bad", "worst", "immoral", "evil", "wrong", "corrupt", "wicked", "iniquitous", "unlawful", "naughty", "hateful", "odious", "repugnant", "repellent", "disgusting", "sinful", "harmful"];
...
function findStems() {
	...
	var myParagraphe = document.getElementsByTagName('body')[0].textContent;

	var wordsTokenized = RiTa.tokenize(myParagraphe);
    // The LANCASTER stemming algorithm seems not to work
    wordsTokenized.analyze();

    console.log(wordsTokenized[0].analyzed(RiTa.PHONEMES));
    // console.log("analyzed " + wordsAnalyzed);
    // var wordStem = RiTa.stem(word, RiTa.LANCASTER);
    
    // console.log("words " + wordStem);
...
//   wordsToIgnore: ['www', 'http', "trump", "hillary", "org"]
//   };

 
//     // var paragraphe = document.createElement('p');
//     // paragraphe.setAttribute('id', "p" + i);

//     // paragraphe.innerHTML = aNewComment;
//     // document.body.insertBefore(paragraphe, document.getElementById("myDiv"));
// }

//  var concord = RiTa.concordance(words, args);

// var arr = sortObject(concord);
// console.log(concord);

// for (var j=0; j<arr.length; j++) {
//   if (arr[j].value > 1) {
//     dessiner(arr[j].key, arr[j].value);
//     // print("value " + arr[j].value + "  key " + arr[j].key);
//   }
